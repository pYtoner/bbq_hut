...
def draw_trapezoid(ax, base1, base2, height, offset, colors, n_points=160):
    ...
    ax.scatter(x_points, y_points, color='red', s=10, c=colors)
...
colors = [(100, 100, 0) for _ in range(160)]

# Draw multiple trapezoids
draw_trapezoid(ax, 3, 5, height, 0, colors)
draw_trapezoid(ax, 3, 5, height, 6, colors)
draw_trapezoid(ax, 3, 5, height, 12, colors)
draw_trapezoid(ax, 3, 5, height, 18, colors)
draw_trapezoid(ax, 3, 5, height, 24, colors)
draw_trapezoid(ax, 3, 5, height, 30, colors)
